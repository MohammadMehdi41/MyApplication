...
import com.example.admin.myapplication.UserSharedPrefManager;
import com.example.admin.myapplication.datamodel.User;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface typeface=Typeface.createFromAsset(getAssets(),"font/irannian_sans.ttf");
