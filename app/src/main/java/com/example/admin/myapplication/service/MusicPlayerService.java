...
public class MusicPlayerService   extends Service {
    private static final String ACTION_PLAY="com.example.admin.myapplication.PLAY_MUSIC";
    private static final String ACTION_FORWARD="com.example.admin.myapplication.FORWARD_MUSIC";
    private static final String ACTION_REWIND="com.example.admin.myapplication.REWIND_MUSIC";
